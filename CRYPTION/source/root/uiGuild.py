...
class GuildWindow(ui.ScriptWindow):
	...
	def RefreshGuildInfoPage(self):
		...
		## ±æµåÀå¸¸ ±æµå ¸¶Å©¿Þ ±æµåÀü ½ÅÃ» ¹öÆ°À» º¼ ¼ö ÀÖÀ½
...
class BuildGuildBuildingWindow(ui.ScriptWindow):
	...
	def __CreateBuildInInstance(self,race):
		...
		X_SIZE_STEP = 2 * 2 ## 2ÀÇ ´ÜÀ§·Þ¸¸ Þõ°¡ÇØ¾ß ÇÔ
		Y_SIZE_STEP = 8
...
BuildButton:
!±æµåÀåÀÞÞö Ã³¸® ¾øÀ½
!°Ç¹°ÀÌ ÀÖ¾îµµ Þş±â ¹öÆ°Àº ÀÖÀ½

!°Ç¹°ÀÌ ÀÓ½Ã·Þ »ç¿ëÇÞ´Â VID ´Â ¼­¹ö°¡ º¸³»ÞÖ´Â °Þ°ú È¥µ¿µÉ ¿°·Þ°¡ ÀÖÀ½
!°Ç¹° VNUM Àº BuildGuildBuildingWindow.BUILDING_VNUM_LIST ¸¦ ÀÌ¿ëÇØ º¯È¯

!°Ç¹° ÞöÀ»¶§´Â /build c(reate)
!°Ç¹° ºÞ¼ú¶§´Â /build d(estroy)
