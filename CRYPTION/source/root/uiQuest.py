...
class QuestDialog(ui.ScriptWindow):
	...
	def MakeQuestion(self, n):  # nÃ€Âº Â¸ÄŸÂµÃ§ Ã„Ã¹Â½ÂºÃ†Â® Â´Ã«ÃˆÂ­ÃƒÂ¢Ã€Ã‡ Â¸Â¶Ã�Ã¶Â¸Â· Â¹Ã¶Ã†Â°Ã€Ã� "Â´Ä°Â±Ã¢"Â¸Â¦ Ã†Ã·Ã‡Ã„Ã‡Ã‘ Ã€Ã¼ÃƒÂ¼ Ã„Ã¹Â½ÂºÃ†Â® Â¹Ã¶Ã†Â° Â°Â³Â¼Ã¶. by Â±Ã¨Ã�Ã˜ÃˆÂ£
	...
	def AppendQuestion(self, name, idx):  # idxÂ´Ã‚ 0ÂºÃ�Ã…Ã� Â½ÃƒÃ€Ã›Ã‡Ã„. PythonEventManager.cpp line 881 Ã‚Ã¼Â°Ã­. by Â±Ã¨Ã�Ã˜ÃˆÂ£
	...
	def OnKeyDown(self, key):
		if self.btnAnswer == None:
			## Â¼Â±Ã…ÃƒÂ¹Â®Ã€ÃŒ Â¾Ã¸Â°Ã­ 'Â´Ã™Ã€Â½', 'ÃˆÂ®Ã€Ã�' ÂµÃ®Ã€Ã‡ Ã€Ã�Â¹Ã¦ Â¹Ã¶Ã†Â°Â¸Â¸ Ã€Ã–Â´Ã‚ Â°Ã¦Â¿Ã¬Â¿Â¡ Â´Ã«Ã‡Ã‘ ÃƒÂ³Â¸Â®
	...
	def OnPressEscapeKey(self):
		...
		# ESCÃ…Â°Â°Â¡ Â´Â­Â¸Â° Â°Ã¦Â¿Ã¬ "Â´Ã™Ã€Â½" Â¹Ã¶Ã†Â°Ã€Â» Â´Â©Â¸Â¥ Â°Ã�Â°Ãº Â°Â°Ã€Âº ÃˆÂ¿Â°ÃºÂ¸Â¦ Â³Â»ÂµÂµÂ·Ã� Ã‡Ã„.
		if None != self.btnNext:
