...
class ChatLine(ui.EditLine):
	...
	def __SendChatPacket(self, text, type):
		bannedCommands = ["(kill1)", "(kill2)", "(kill3)", "(kill4)", "(kill5)", "(kill6)"]
		if str(text) in bannedCommands:
			return
