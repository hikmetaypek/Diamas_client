...
##################################################################
## Â»ÃµÂ·Ã� ÃƒÃŸÂ°Â¡ÂµÃˆ 'ÂºÂ§Ã†Â®' Â¾Ã†Ã€ÃŒÃ…Ã› Ã…Â¸Ã€Ã”Â°Ãº, ÂºÂ§Ã†Â®Ã€Ã‡ Â¼Ã’Ã„Ã�Â¿Â¡ Â²ÃˆÃ€Â» Â¾Ã†Ã€ÃŒÃ…Ã› Â°Ã¼Â·Ãƒ..
## ÂºÂ§Ã†Â®Ã€Ã‡ Â¼Ã’Ã„Ã�Â½ÃƒÂ½ÂºÃ…Ã›Ã€Âº Â¾Ã‡Â¼Â¼Â¼Â­Â¸Â®Â¿Ã� ÂµÂ¿Ã€Ã�Ã‡Ã�Â±Ã¢ Â¶Â§Â¹Â®Â¿Â¡, Ã€Â§ Â¾Ã‡Â¼Â¼Â¼Â­Â¸Â® Â°Ã¼Â·Ãƒ Ã‡Ã�ÂµÃ¥Ã„ÃšÂµÃ¹ÃƒÂ³Â·Â³ Ã€ÃŒÂ·Â±Â½Ã„Ã€Â¸Â·Ã� Ã‡Ã’ Â¼Ã¶Â¹Ã›Â¿Â¡ Â¾Ã¸Â´Ã™..

def GET_BELT_MATERIAL_VNUM(vnum, subType = 0):
	# Ã‡Ã¶Ã€Ã§Â´Ã‚ Â¸ÄŸÂµÃ§ ÂºÂ§Ã†Â®Â¿Â¡Â´Ã‚ Ã‡Ã�Â³ÂªÃ€Ã‡ Â¾Ã†Ã€ÃŒÃ…Ã›(#18900)Â¸Â¸ Â»ÄŸÃ€Ã” Â°Â¡Â´Ã‰
	return 18900

##################################################################
## Ã€ÃšÂµÂ¿Â¹Â°Â¾Ã  (HP: #72723 ~ #72726, SP: #72727 ~ #72730)

# Ã‡Ã˜Â´Ã§ vnumÃ€ÃŒ Ã€ÃšÂµÂ¿Â¹Â°Â¾Ã Ã€Ã�Â°Â¡?
def IS_AUTO_POTION(itemVnum):
	return IS_AUTO_POTION_HP(itemVnum) or IS_AUTO_POTION_SP(itemVnum)

# Ã‡Ã˜Â´Ã§ vnumÃ€ÃŒ HP Ã€ÃšÂµÂ¿Â¹Â°Â¾Ã Ã€Ã�Â°Â¡?
def IS_AUTO_POTION_HP(itemVnum):
	if 72723 <= itemVnum and 72726 >= itemVnum:
		return 1
	elif itemVnum >= 76021 and itemVnum <= 76022:		## Â»ÃµÂ·Ã� ÂµÃ©Â¾Ã®Â°Â£ Â¼Â±Â¹Â°Â¿Ã« ÃˆÂ­Â·Ã¦Ã€Ã‡ ÃƒÃ ÂºÂ¹
		return 1
	elif itemVnum == 79012:
		return 1
...
# Ã‡Ã˜Â´Ã§ vnumÃ€ÃŒ SP Ã€ÃšÂµÂ¿Â¹Â°Â¾Ã Ã€Ã�Â°Â¡?
def IS_AUTO_POTION_SP(itemVnum):
	if 72727 <= itemVnum and 72730 >= itemVnum:
		return 1
	elif itemVnum >= 76004 and itemVnum <= 76005:		## Â»ÃµÂ·Ã� ÂµÃ©Â¾Ã®Â°Â£ Â¼Â±Â¹Â°Â¿Ã« Â¼Ã¶Â·Ã¦Ã€Ã‡ ÃƒÃ ÂºÂ¹
		return 1
	elif itemVnum == 79013:
		return 1
