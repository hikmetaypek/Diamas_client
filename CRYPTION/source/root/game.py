...
class GameWindow(ui.ScriptWindow):
	def __init__(self, stream):
		...
		#wj 2014.1.2. ESCÅ°¸¦ ´©¸¦ ½Ã ¿ì¼±ÀûÀ¸·Þ DropQuestionDialog¸¦ ²ôµµ·Þ ¸¸µé¾ú´Ù. ÇÞÞö¸¸ Ã³À½¿¡ itemDropQuestionDialog°¡ ¼±¾ğµÇ¾î ÀÖÞö ¾Ê¾Æ ERROR°¡ ¹ß»ıÇÞ¿© init¿¡¼­ ¼±¾ğ°ú µ¿½Ã¿¡ ÃÊ±âÈ­ ½ÃÅ´.
	...
	def Open(self):
		...
		if not constInfo.CLIENTLESS_TEST_SERVER:
			try:
				self.StartGame()
			except:
				import exception
			...
			self.MakeFakeCharacter(1, 0, 30000, 40000)
			player.SetMainCharacterIndex(1)
			chr.SelectInstance(1)

		# NPC°¡ Å¥ºê½Ã½ºÅÛÀ¸·Þ ¸¸µé ¼ö ÀÖ´Â ¾ÆÀÌÅÛµéÀÇ ¸ñ·ÞÀ» Ä³½Ì
	...
	def __BuildKeyDict(self):
		...
		## F12 ´Â Å¬¶ó µğ¹ö±×¿ë Å°ÀÌ¹Ç·Þ ¾²Þö ¾Ê´Â °Ô ÞÞ´Ù.
	...
	def MakeFakeCharacter(self, index, race, x, y):
		...
		chr.SetRace(race)
		chr.SetArmor(11009+race*200)
		chr.SetHair(0)
		chr.SetNameString("DENEME12")
		chr.Refresh()
	...
	def AddDropItemToTarget(self, slot, itemVnum):
		self.targetBoard.AddDropItem(slot, itemVnum)

	def AddBonusesInfoToTarget(self, value):
		self.targetBoard.AppendBonuses(value)
		
	def CreateItems(self):
		self.targetBoard.CreateItemsDrop()
	...
	def SaveScreen(self):
		...
		if succeeded:
			chat.AppendChat(chat.CHAT_TYPE_INFO, localeInfo.SCREENSHOT_SAVE1 + ": " + name + localeInfo.SCREENSHOT_SAVE2)
		else:
			chat.AppendChat(chat.CHAT_TYPE_INFO, localeInfo.SCREENSHOT_SAVE_FAILURE)

	def ShowConsole(self):
		if self.consoleEnable or constInfo.CLIENTLESS_TEST_SERVER:
	...
	def __DropMoney(self, attachedType, attachedMoney):
		# PRIVATESHOP_DISABLE_ITEM_DROP - °³ÀÞ»óÞ¡ ¿­°í ÀÖ´Â µ¿¾È ¾ÆÀÌÅÛ ¹ö¸² ¹æÞö
	...
	# Þ¦ÀÛ¿¡ ÇÊ¿äÇÑ °ñµå, ¿¹»óµÇ´Â ¿Þ¼ºÇ°ÀÇ VNUM°ú °³¼ö Þ¤º¸ update
	...
	def BINARY_Cube_ResultList(self, npcVNUM, listText):
		# ResultList Text Format : 72723,1/72725,1/72730.1/50001,5  ÀÌ·±½ÄÀ¸·Þ "/" ¹®ÀÚ·Þ ±¸ºĞµÈ ¸®½ºÆ®¸¦ ÞÜ
		#print listText
	...
	def __ServerCommand_Build(self):
		serverCommandList={
			...
			"war_info"				: self.__GuildWar_UpdateMemberCount,
			...
			"getinputbegin"			: self.__BlockInput,
			"getinputend"			: self.__BreakBlockInput,
	...
	def __BlockInput(self):
		constInfo.INPUT_IGNORE = 1

	def __BreakBlockInput(self):
