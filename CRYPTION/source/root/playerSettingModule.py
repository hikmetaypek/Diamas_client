...
def __InitData():
	...
	#¶ó¸¶´Ü ÃÊ½Â´ŞÀÇ ¹İÁö(71135) Âø¿ë¼ø°£ ¹ßµ¿ ÀÌÆåÆ®
	...
	chrmgr.RegisterCacheEffect(chrmgr.EFFECT_LEVELUP_UNDER_15_FOR_GERMANY, "", "season1/effect/paymessage_decide.mse" )#·¹º§¾÷ 15ÀÏ¶§ ( µ¶ÀÏÀü¿ë )
...
def __LoadGameEffect():
	...
	effect.RegisterIndexedFlyData(effect.FLY_CHAIN_LIGHTNING, effect.INDEX_FLY_TYPE_NORMAL, "d:/ymir work/pc/shaman/effect/pokroe.msf")						## Æø·Ú°İ
...
def LoadGuildBuildingList(filename):
	...
	for line in OpenVfsFile("npcList.txt"):
		...
		## GuildSymbol Àº ÀÏ¹İ NPC µé°ú ÇÔ²² µî·ÏÇÑ´Ù.
		import chrmgr
